...
% Ahora, dado el principal objetivo de los Smart Campus es la recolección de información, con fines de monitoreo para la toma de decisiones entre otros \cite{MinAllah2020, Anagnostopoulos_2023}; los requerimientos deben estar orientados principalmente hacia los dispositivos y los datos que estos recolectan.asdasd
