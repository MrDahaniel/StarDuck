   ...
   \begin{enumerate}[label=\thesubsection.\arabic*., wide, labelindent=2em, leftmargin=5em]
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|l|l|c|c|c|}
            \hline
            \textbf{Descripción} & \textbf{Responsable} & \multicolumn{1}{l|}{\textbf{Valor}} & \multicolumn{1}{l|}{\textbf{Cantidad}} & \multicolumn{1}{l|}{\textbf{Precio}} \\ \hline
            DIRECTOR DE PROYECTO PhD. Gabriel Rodrigo Pedraza Ferreira & \multicolumn{1}{c|}{UIS} & \$305,000.00 & 16 & \$4,880,000.00 \\ \hline
            CODIRECTOR DE PROYECTO MSc. Henry Andrés Jiménez Herrera & \multicolumn{1}{c|}{UIS} & \$305,000.00 & 16 & \$4,880,000.00 \\ \hline
            Computador Portátil & Daniel Delgado & \multicolumn{1}{r|}{\$6,317,405.00} & \multicolumn{1}{r|}{1} & \$6,317,405.00 \\ \hline
        \end{tabular}
        }
    \end{table}
